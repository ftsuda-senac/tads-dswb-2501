...
public class DadosController {
    ...
    public UsuarioSistemaDto obterDados(Authentication authn) {
        ...
        // JwtAuthenticationFilter já converteu o token JWT em um objeto UsuarioSistema e o colocou no contexto de segurança
        // Se quiser, pode injetar diretamente o UsuarioSistema no método usando a anotação @AuthenticationPrincipal (ver funcoes abaixo)
